...
var queryChaincode = function(peer, channelName, chaincodeName, args, fcn, username,password, org) {
	var channel = helper.getChannelForOrg(org);
	var client = helper.getClientForOrg(org);
	var target = buildTarget(peer, org);
	return helper.enrollUser(username,password, org).then((user) => {
...
var getBlockByNumber = function(peer, blockNumber, username,password, org) {
	var target = buildTarget(peer, org);
	var channel = helper.getChannelForOrg(org);

	return helper.enrollUser(username,password, org).then((member) => {
...
var getTransactionByID = function(peer, trxnID, username, password,org) {
	var target = buildTarget(peer, org);
	var channel = helper.getChannelForOrg(org);
...
var getBlockByHash = function(peer, hash, username,password, org) {
	var target = buildTarget(peer, org);
	var channel = helper.getChannelForOrg(org);
...
var getChainInfo = function(peer, username, password,org) {
	var target = buildTarget(peer, org);
	var channel = helper.getChannelForOrg(org);
...
var getChannels = function(peer, username, password,org) {
	var target = buildTarget(peer, org);
	var channel = helper.getChannelForOrg(org);
	var client = helper.getClientForOrg(org);
